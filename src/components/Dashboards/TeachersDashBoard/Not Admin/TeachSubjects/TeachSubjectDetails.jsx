...
//   const [noTermOrSession, setNoTermOrSession] = useState(false); // Handle missing term/session
//   const [isReset, setIsReset] = useState(false); // Track if marks were reset for the current term
...
//         if (!termData || !termData.session || !termData.termName) {
...
//           // Reset marks if this is a new `isCurrent` term
//           if (!isReset) {
//             await resetMarksForCurrentTerm(termData._id);
//             setIsReset(true); // Ensure marks aren't reset again for this term
//           }
//         }
...
//   // Function to reset marks for the current term
//   const resetMarksForCurrentTerm = async (termId) => {
//     try {
//       const response = await fetch(
//         "http://localhost:8080/api/mark/reset",
//         {
//           method: "POST",
//           headers: {
...
//             Authorization: `Bearer ${localStorage.getItem("token")}`,
//           },
//           body: JSON.stringify({ termId, subjectId }),
//         }
//       );
//       if (!response.ok) {
//         throw new Error("Failed to reset marks for the current term.");
//       }
//       console.log("Marks reset for term:", termId);
//     } catch (error) {
...
//                         >
//                           <FaSave /> <span className="d-none d-md-inline">Save</span>
//                         </Button>
//                         <Button
//                           variant="primary"
//                           onClick={() => handleFinalizeMarks(student.id)}
//                         >
//                           <FaCheckCircle /> <span className="d-none d-md-inline">Finalize</span>
//                         </Button>
//                       </td>
//                     </tr>
//                   );
